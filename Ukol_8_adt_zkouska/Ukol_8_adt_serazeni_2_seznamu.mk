...
##
## Debug
ProjectName            :=Ukol_8_adt_serazeni_2_seznamu
ConfigurationName      :=Debug
WorkspacePath          :="C:/Users/milan/Disk Google/codeline/codeline/Skola_ukoly"
ProjectPath            :="C:/Users/milan/Disk Google/codeline/codeline/Skola_ukoly/Ukol_8_adt_zkouska"
...
ObjectsFileList        :="Ukol_8_adt_serazeni_2_seznamu.txt"
PCHCompileFlags        :=
...
##
Objects0=$(IntermediateDirectory)/ioutils.c$(ObjectSuffix) $(IntermediateDirectory)/main.c$(ObjectSuffix) $(IntermediateDirectory)/list.c$(ObjectSuffix) $(IntermediateDirectory)/data.c$(ObjectSuffix) $(IntermediateDirectory)/mymalloc.c$(ObjectSuffix) 
...
$(IntermediateDirectory)/ioutils.c$(ObjectSuffix): ioutils.c $(IntermediateDirectory)/ioutils.c$(DependSuffix)
	$(CC) $(SourceSwitch) "C:/Users/milan/Disk Google/codeline/codeline/Skola_ukoly/Ukol_8_adt_zkouska/ioutils.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/ioutils.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/main.c$(ObjectSuffix): main.c $(IntermediateDirectory)/main.c$(DependSuffix)
	$(CC) $(SourceSwitch) "C:/Users/milan/Disk Google/codeline/codeline/Skola_ukoly/Ukol_8_adt_zkouska/main.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/list.c$(ObjectSuffix): list.c $(IntermediateDirectory)/list.c$(DependSuffix)
	$(CC) $(SourceSwitch) "C:/Users/milan/Disk Google/codeline/codeline/Skola_ukoly/Ukol_8_adt_zkouska/list.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/list.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/data.c$(ObjectSuffix): data.c $(IntermediateDirectory)/data.c$(DependSuffix)
	$(CC) $(SourceSwitch) "C:/Users/milan/Disk Google/codeline/codeline/Skola_ukoly/Ukol_8_adt_zkouska/data.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/data.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/mymalloc.c$(ObjectSuffix): mymalloc.c $(IntermediateDirectory)/mymalloc.c$(DependSuffix)
	$(CC) $(SourceSwitch) "C:/Users/milan/Disk Google/codeline/codeline/Skola_ukoly/Ukol_8_adt_zkouska/mymalloc.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/mymalloc.c$(ObjectSuffix) $(IncludePath)
