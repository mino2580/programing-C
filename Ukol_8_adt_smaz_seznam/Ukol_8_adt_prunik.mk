...
ProjectPath            :="D:/1rocnik Letny/Disk Google 1/codeline/codeline/Skola_ukoly/Ukol_8_adt_prunik"
...
Objects0=$(IntermediateDirectory)/main.c$(ObjectSuffix) $(IntermediateDirectory)/ioutils.c$(ObjectSuffix) $(IntermediateDirectory)/mymalloc.c$(ObjectSuffix) $(IntermediateDirectory)/data.c$(ObjectSuffix) $(IntermediateDirectory)/list.c$(ObjectSuffix) 
...
$(IntermediateDirectory)/main.c$(ObjectSuffix): main.c $(IntermediateDirectory)/main.c$(DependSuffix)
	$(CC) $(SourceSwitch) "D:/1rocnik Letny/Disk Google 1/codeline/codeline/Skola_ukoly/Ukol_8_adt_prunik/main.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/ioutils.c$(ObjectSuffix): ioutils.c $(IntermediateDirectory)/ioutils.c$(DependSuffix)
	$(CC) $(SourceSwitch) "D:/1rocnik Letny/Disk Google 1/codeline/codeline/Skola_ukoly/Ukol_8_adt_prunik/ioutils.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/ioutils.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/mymalloc.c$(ObjectSuffix): mymalloc.c $(IntermediateDirectory)/mymalloc.c$(DependSuffix)
	$(CC) $(SourceSwitch) "D:/1rocnik Letny/Disk Google 1/codeline/codeline/Skola_ukoly/Ukol_8_adt_prunik/mymalloc.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/mymalloc.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/data.c$(ObjectSuffix): data.c $(IntermediateDirectory)/data.c$(DependSuffix)
	$(CC) $(SourceSwitch) "D:/1rocnik Letny/Disk Google 1/codeline/codeline/Skola_ukoly/Ukol_8_adt_prunik/data.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/data.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/list.c$(ObjectSuffix): list.c $(IntermediateDirectory)/list.c$(DependSuffix)
	$(CC) $(SourceSwitch) "D:/1rocnik Letny/Disk Google 1/codeline/codeline/Skola_ukoly/Ukol_8_adt_prunik/list.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/list.c$(ObjectSuffix) $(IncludePath)
