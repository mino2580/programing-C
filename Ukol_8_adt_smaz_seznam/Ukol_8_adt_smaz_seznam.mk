...
##
## Debug
ProjectName            :=Ukol_8_adt_smaz_seznam
ConfigurationName      :=Debug
WorkspacePath          :="D:/1rocnik Letny/Disk Google 1/codeline/codeline/Skola_ukoly"
ProjectPath            :="D:/1rocnik Letny/Disk Google 1/codeline/codeline/Skola_ukoly/Ukol_8_adt_smaz_seznam"
...
ObjectsFileList        :="Ukol_8_adt_smaz_seznam.txt"
PCHCompileFlags        :=
...
Objects0=$(IntermediateDirectory)/main.c$(ObjectSuffix) $(IntermediateDirectory)/data.c$(ObjectSuffix) $(IntermediateDirectory)/list.c$(ObjectSuffix) $(IntermediateDirectory)/ioutils.c$(ObjectSuffix) $(IntermediateDirectory)/mymalloc.c$(ObjectSuffix) 
...
$(IntermediateDirectory)/main.c$(ObjectSuffix): main.c $(IntermediateDirectory)/main.c$(DependSuffix)
	$(CC) $(SourceSwitch) "D:/1rocnik Letny/Disk Google 1/codeline/codeline/Skola_ukoly/Ukol_8_adt_smaz_seznam/main.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/data.c$(ObjectSuffix): data.c $(IntermediateDirectory)/data.c$(DependSuffix)
	$(CC) $(SourceSwitch) "D:/1rocnik Letny/Disk Google 1/codeline/codeline/Skola_ukoly/Ukol_8_adt_smaz_seznam/data.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/data.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/list.c$(ObjectSuffix): list.c $(IntermediateDirectory)/list.c$(DependSuffix)
	$(CC) $(SourceSwitch) "D:/1rocnik Letny/Disk Google 1/codeline/codeline/Skola_ukoly/Ukol_8_adt_smaz_seznam/list.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/list.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/ioutils.c$(ObjectSuffix): ioutils.c $(IntermediateDirectory)/ioutils.c$(DependSuffix)
	$(CC) $(SourceSwitch) "D:/1rocnik Letny/Disk Google 1/codeline/codeline/Skola_ukoly/Ukol_8_adt_smaz_seznam/ioutils.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/ioutils.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/mymalloc.c$(ObjectSuffix): mymalloc.c $(IntermediateDirectory)/mymalloc.c$(DependSuffix)
	$(CC) $(SourceSwitch) "D:/1rocnik Letny/Disk Google 1/codeline/codeline/Skola_ukoly/Ukol_8_adt_smaz_seznam/mymalloc.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/mymalloc.c$(ObjectSuffix) $(IncludePath)
