...
##
## Debug
ProjectName            :=Ukol_8_adt_list
ConfigurationName      :=Debug
WorkspacePath          :="C:/Users/milan/Disk Google/codeline/codeline/Skola_ukoly"
ProjectPath            :="C:/Users/milan/Disk Google/codeline/codeline/Skola_ukoly/Ukol_8_adt_list"
...
ObjectsFileList        :="Ukol_8_adt_list.txt"
PCHCompileFlags        :=
...
$(IntermediateDirectory)/main.c$(ObjectSuffix): main.c $(IntermediateDirectory)/main.c$(DependSuffix)
	$(CC) $(SourceSwitch) "C:/Users/milan/Disk Google/codeline/codeline/Skola_ukoly/Ukol_8_adt_list/main.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/ioutils.c$(ObjectSuffix): ioutils.c $(IntermediateDirectory)/ioutils.c$(DependSuffix)
	$(CC) $(SourceSwitch) "C:/Users/milan/Disk Google/codeline/codeline/Skola_ukoly/Ukol_8_adt_list/ioutils.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/ioutils.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/data.c$(ObjectSuffix): data.c $(IntermediateDirectory)/data.c$(DependSuffix)
	$(CC) $(SourceSwitch) "C:/Users/milan/Disk Google/codeline/codeline/Skola_ukoly/Ukol_8_adt_list/data.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/data.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/mymalloc.c$(ObjectSuffix): mymalloc.c $(IntermediateDirectory)/mymalloc.c$(DependSuffix)
	$(CC) $(SourceSwitch) "C:/Users/milan/Disk Google/codeline/codeline/Skola_ukoly/Ukol_8_adt_list/mymalloc.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/mymalloc.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/list.c$(ObjectSuffix): list.c $(IntermediateDirectory)/list.c$(DependSuffix)
	$(CC) $(SourceSwitch) "C:/Users/milan/Disk Google/codeline/codeline/Skola_ukoly/Ukol_8_adt_list/list.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/list.c$(ObjectSuffix) $(IncludePath)
